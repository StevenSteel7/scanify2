package com.steve.scanify.ui.custom
...
/*android development, the R file is automatically generated by the Android build tools and contains references
to all the resources (such as layouts, drawables, strings, etc.) used in the Android application.
Developers reference these resources in their code using the R class to access elements defined in XML files.*/
